...
int Z80Emulate (Z80_STATE *state, int number_cycles/*, void *context*/)
{
		...
		if(state->halted) return number_cycles;
...
emulate_next_opcode:
                ...
                instruction = pgm_read_byte(&INSTRUCTION_TABLE[opcode]);
...
emulate_next_instruction:
                ...
                switch (instruction) {
                        ...
                        case LD_A_I_LD_A_R: {
                                ...
                                a = opcode == OPCODE_LD_A_I 
                                        ? state->i 
                                        : (state->r & 0x80) | (r & 0x7f);
                                f = pgm_read_byte(&SZYX_FLAGS_TABLE[a]);
                        ...
                        case CPI_CPD: {
                                ...
                                f |= pgm_read_byte(&SZYX_FLAGS_TABLE[z & 0xff]) & SZ_FLAGS;
                                f |= --BC ? Z80_P_FLAG : 0;
                        ...
                        case DAA: {
                                ...
                                A += F & Z80_N_FLAG ? -d : +d;
                                F = pgm_read_byte(&SZYXP_FLAGS_TABLE[A])
                                        | ((A ^ a) & Z80_H_FLAG)
                                        | (F & Z80_N_FLAG)
                                        | c;
                        ...
                        case NEG: {
                                ...
                                f |= pgm_read_byte(&SZYX_FLAGS_TABLE[z &= 0xff]);
                                c &= 0x0180;
				...
				if ((Y(opcode) & 0x03) <= 0x01)
                        ...
                        case RLD_RRD: {
                                ...
                                A = y; 
                                F = pgm_read_byte(&SZYXP_FLAGS_TABLE[y]) | (F & Z80_C_FLAG);
                        ...
                        case IN_R_C: {
                                ...
                                F = pgm_read_byte(&SZYXP_FLAGS_TABLE[x]) | (F & Z80_C_FLAG);
                        ...
                        case INI_IND: {
                                ...
                                f = pgm_read_byte(&SZYX_FLAGS_TABLE[--B & 0xff])
                                ...
                                f |= pgm_read_byte(&SZYXP_FLAGS_TABLE[(x & 0x07) ^ B])
                                        & Z80_P_FLAG;
                                F = f;
                        ...
                        case INIR_INDR: {
                                ...
                                for ( ; ; ) {
                                        ...
                                        || ((hl - d) & 0xffff) == q) { 
                                                ...
                                                f = pgm_read_byte(&SZYX_FLAGS_TABLE[b]);
                                                pc -= 2;
                                                break;
                        ...
                        case CB_PREFIX: {
                                ...
                                instruction = pgm_read_byte(&CB_INSTRUCTION_TABLE[opcode]);
					...
					state->status = Z80_STATUS_PREFIX;
                        ...
                        case ED_PREFIX: {
                                ...
                                Z80_FETCH_BYTE(pc, opcode);
                                pc++;
                                instruction = pgm_read_byte(&ED_INSTRUCTION_TABLE[opcode]);
