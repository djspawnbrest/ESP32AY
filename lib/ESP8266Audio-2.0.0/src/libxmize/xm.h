...
bool IRAM_ATTR xm_sample(xm_context_t* ctx, float* p_left, float* p_right);
...
/** Get the instrument name as a NUL-terminated string. */
const char* xm_get_instrument_name(xm_context_t*,uint16_t);
